YOUR_NAME="Clovis B. Tsopgo"
YOUR_ADDRESS="8301 Willow Pl Dr N"
CANIDATE_CITY_STATE_ZIP_CODE="77070"
YOUR_EMAIL_ADDRESS="tsclovis@yahoo.fr"
YOUR_PHONE_NUMBER="7133557624"
PREVIOUS_COMPANY="Aspen Utility LLC"
JOB_TITLE="DevOps Engineer"
DATE=$(date +"%Y-%m-%d")

EMPLOYER_NAME="John Doe"
COMPANY_NAME="ATT"
COMPANY_ADDRESS="6027 Kirby Dr"
EMPLOYER_CITY_STATE_ZIP_CODE="7705"
